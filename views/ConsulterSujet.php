...
<?php if(isset($_SESSION['id'])) { ?>
   <form method="POST">
      <textarea placeholder="Votre réponse" name="commentaire" style="width:80%"><?php if(isset($commentaire)) { echo $commentaire; } ?></textarea><br />
      <input type="submit" name="commentaire" value="Poster ma réponse"></form>
   </form>
                                            ...
                                            <table border=1 align = 'center'>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?PHP echo $commentaire['userid']; ?></td>
                                                        <td> 
                                                        <button class="btn btn-primary" ><i class="fas fa-eye"></i> react</button>
                                                         </td>					
                                                    </tr>
                                                <?PHP
                                                    }
